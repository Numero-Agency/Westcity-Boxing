...
if( is_plugin_active('memberpress/memberpress.php') ) {
  ...
  define('MPIMP_PATH', dirname(__DIR__) . '/' . MPIMP_PLUGIN_NAME);
  define('MPIMP_IMPORTERS_PATH', MPIMP_PATH . '/importers');
  define('MPIMP_URL', plugins_url('/' . MPIMP_PLUGIN_NAME));
  ...
  class MpimpAppController {
    ...
    public function addon_updates() {
      if(class_exists('MeprAddonUpdates')) {
        new MeprAddonUpdates(
          ...
          'Import MemberPress data from a csv file.'
        );
      }
    }
    ...
    public function load_scripts($hook) {
      if(preg_match('/_page_memberpress-import$/',$hook)) {
