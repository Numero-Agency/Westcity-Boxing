<div id="new-student-form" class="mpch-modal mpch-modal-new-coach mfp-hide">
  <div class="mpch-modal__content">
    ...
    <div class="mpch-modal__footer">
      <button class="button mpch-metabox__button --link" data-trigger="add-student" data-mfp-src="#add-student-form"><?php esc_html_e( 'Add From Users', 'memberpress-coachkit' ); ?></button>
      <button type="button" class="button button-primary mpch-modal__button" data-new="student">
        <svg class="" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" style="opacity: 0.25;"></circle>
          <path class="tw-opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
        </svg>
        <?php echo esc_html_x( 'Create', 'ui', 'memberpress-coachkit' ); ?>
      </button>
    </div>
  </div>
</div>
