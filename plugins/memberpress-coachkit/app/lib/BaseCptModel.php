...
abstract class BaseCptModel extends BaseBuiltinModel {
  ...
  protected function load_cpt_from_id( $id ) {
    ...
    // error_log( 'load_cpt_from_id ID: ' . $id . ' => ' . print_r( $post, true ) );

    $class = get_class( $this );
    $cpt   = Utils::get_constant( $class, 'CPT' );
  ...
  public function destroy() {
    ...
    if ( false === $res ) {
      throw new CreateException( sprintf( __( 'This was unable to be deleted.', 'memberpress-coachkit' ) ) );
    }
