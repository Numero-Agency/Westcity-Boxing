      ...
      <div class="accordion__item">
        ...
        <ul class="accordion__content student-group-modal">
          ...
          foreach ( $program->groups as $key => $group ) { ?>
            <li class="coach-group-modal__list <?php echo $group->css; ?>">
              <label class="coach-group-modal__link space-x-2" data-select-coach>
                ...
                <input type="radio" name="mpch-coach-group-id" value="<?php echo esc_attr( $group->id ); ?>">
                <span><?php echo esc_html( ucfirst( $group->title ) ); ?> - </span>
                <em><?php echo esc_html( ucfirst( $group->coach ) ); ?></em>
              </label>
            </li>
          <?php }
          ?>
