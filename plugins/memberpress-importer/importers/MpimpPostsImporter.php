...
class MpimpPostsImporter extends MpimpBaseImporter {
  ...
  public function import_post($row,$args) {
    ...
    if ( is_wp_error( $post_id ) ) {
      throw new Exception(sprintf(__('Post failed to be created: %s', 'memberpress-importer'), $post_id->get_error_message()));
    }
    else {
      ...
      return sprintf(__('Post (ID = %d) was created successfully', 'memberpress-importer'), $post_id);
    }
  }
}
