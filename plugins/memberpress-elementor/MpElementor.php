...
class MpElementor {
  ...
  public function __construct() {
    add_action('plugin_loaded', array($this, 'addon_updates'));
  ...
  public function addon_updates() {
    if(class_exists('MeprAddonUpdates')) {
      new MeprAddonUpdates(
        ...
        'Elementor integration to protect content with MemberPress.'
      );
    }
  }
  ...
  public function unauth_content( $settings ) {
    ...
    if( apply_filters( 'mp_elementor_include_section_html', true ) ) {
      ob_start();
      ?>
